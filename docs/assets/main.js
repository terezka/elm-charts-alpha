...
var _terezka$line_charts$Internal_Dots$view = F2(
	function ($arguments, datum) {
		...
		var shape = datum.isOutlier ? $arguments.outlier.shape : $arguments.shape;
		var _p12 = $arguments.dotsConfig;
		var config = _p12._0;
		var _p13 = datum.isOutlier ? $arguments.outlier.style : config.individual(datum.user);
		var style = _p13._0;
...
var _terezka$line_charts$Internal_Dots$custom = function (style) {
	return _terezka$line_charts$Internal_Dots$Config(
		{
			legend: function (_p14) {
				return style;
			},
			individual: function (_p15) {
				return style;
			}
		});
};
...
var _terezka$line_charts$Internal_Group$viewSample = F6(
	function (dotsConfig, lineConfig, system, line, data, sampleWidth) {
		var shape_ = _terezka$line_charts$Internal_Group$shape(line);
