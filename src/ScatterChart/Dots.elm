module ScatterChart.Dots exposing
  ( Shape
...
The shape type changes the shape of your dots.
    ...
    humanChart : Html msg
    humanChart =
      ScatterChart.view .age .income
        [ ScatterChart.line Colors.gold Dots.circle  "Alice" alice
        --                           ^^^^^^^^^^^
        , ScatterChart.line Colors.blue Dots.square  "Bobby" bobby
        --                           ^^^^^^^^^^^
        , ScatterChart.line Colors.pink Dots.diamond "Chuck" chuck
        --                           ^^^^^^^^^^^^
        ]
