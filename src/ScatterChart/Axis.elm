...
Properties:
  ...
  - **title**: Adds a title on your axis. </br>
    _See `ScatterChart.Axis.Title` for more information and examples._
  ...
  - **range**: Determines the axis range. </br>
    _See `ScatterChart.Axis.Range` for more information and examples._
  - **axisLine**: Customizes your axis line. </br>
    _See `ScatterChart.Axis.Line` for more information and examples._
  - **ticks**: Customizes your ticks. </br>
    _See `ScatterChart.Axis.Ticks` for more information and examples._
