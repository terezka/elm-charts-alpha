...
{-| -}
view : Coordinate.System -> Config data -> Group.Config data -> List (Group.Group data) -> List (List (Data.Data Data.ScatterChart data)) -> Svg.Svg msg
...
viewSingle : Coordinate.System -> Color.Color -> Function -> Width data -> Bool -> List (Data.Data Data.ScatterChart data) -> Svg.Svg msg
